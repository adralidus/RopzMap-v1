        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {roadmaps.map((roadmap) => (
            <div
              ...
              className="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-200 cursor-pointer transform hover:scale-[1.02]"
            >
              <div className="p-5">
              ...
              <div className="bg-slate-50 dark:bg-slate-900 px-5 py-2 flex justify-between transition-colors">
                ...
                <button
                  ...
                  className="text-xs font-medium text-slate-700 dark:text-slate-400 flex items-center transition-colors"
                >
          ...
          <div
            onClick={() => setIsNewRoadmapDialogOpen(true)}
            className="bg-slate-50 dark:bg-slate-900 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 transition-colors"
          >
